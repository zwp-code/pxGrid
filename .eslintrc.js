module.exports = {
    ...
    rules: {
        ...
        'no-invalid-this': 0, // 禁止无效的this，只能用在构造器，类，对象字面量------old 0  要求2
        ...
        'no-shadow': 1, // 外部作用域中的变量不能与它所包含的作用域中的变量或参数同名------old 1 要求2
        ...
        'eqeqeq': 1, // 必须使用全等------old 1  要求2
        'func-names': 0, // 函数表达式必须有名字
        'func-style': [0, 'declaration'], // 函数风格，规定只能使用函数声明/函数表达式
        'generator-star-spacing': 0, // 生成器函数*的前后空格
        'guard-for-in': 0, // for in循环要用if语句过滤
        'handle-callback-err': [0, '^.*(e|E)rr'], // 强制回调错误处理
        'id-length': [1, {'min': 1, 'max': 30}], // 变量名长度
        'id-match': [0, '^[a-z$]+([a-zA-Z0-9]+)*$'], // 命名检测
        'indent': [1, 4, {'SwitchCase': 2}], // 缩进4格
